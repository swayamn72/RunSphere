...
| ---------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| [Onboarding](design/onboarding-welcome-default.html)             | Running is the only activity type; mandatory adult age assertion before activation. Walk/hike options shown in old mockups must be removed. |
...
| [Home](design/home-dashboard-default.html)                       | Weekly goals use server-provided validated activity only; Home shows route suggestion card and fetched verified quest summaries. |
| [Live activity](design/live-activity-default.html)               | Live metrics are provisional; server validates distance, quests, and territory later. Map shows path overlay, relocation button, zoom controls (see [`map-ux.md`](map-ux.md)). |
...
| [Profile settings](design/profile-settings-default.html)         | Settings include activity visibility, 200 m zones, safety contacts, export, and deletion. Walk/run/hike preference field is removed.      |
